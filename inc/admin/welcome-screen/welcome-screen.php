...
class themotion_Welcome {
	...
	public function themotion_welcome_admin_notice() {
		?>
			<div class="updated notice is-dismissible">
				<p><?php echo sprintf( esc_html__( 'Welcome! Thank you for choosing TheMotion! To fully take advantage of the best our theme can offer please make sure you visit our %1$swelcome page%1$s.', 'themotion-lite' ), '<a href="' . esc_url( admin_url( 'themes.php?page=themotion-welcome' ) ) . '">', '</a>' ); ?></p>
				<p><a href="<?php echo esc_url( admin_url( 'themes.php?page=themotion-welcome' ) ); ?>" class="button" style="text-decoration: none;"><?php _e( 'Get started with TheMotion', 'themotion-lite' ); ?></a></p>
			</div>
		<?php
	}
	...
	public function themotion_welcome_style_and_scripts( $hook_suffix ) {
		...
		if ( 'appearance_page_themotion-welcome' == $hook_suffix ) {
			...
			wp_localize_script( 'themotion-welcome-screen-js', 'themotionLiteWelcomeScreenObject', array(
				...
				'no_required_actions_text' => __( 'Hooray! There are no required actions for you right now.','themotion-lite' ),
			) );
		}
	}
	...
	public function themotion_welcome_screen() {
		...
		<ul class="themotion-nav-tabs" role="tablist">
			<li role="presentation" class="active"><a href="#getting_started" aria-controls="getting_started" role="tab" data-toggle="tab"><?php esc_html_e( 'Getting started','themotion-lite' ); ?></a></li>
			<li role="presentation" class="themotion-w-red-tab"><a href="#actions_required" aria-controls="actions_required" role="tab" data-toggle="tab"><?php esc_html_e( 'Actions required','themotion-lite' ); ?></a></li>
			<li role="presentation"><a href="#changelog" aria-controls="changelog" role="tab" data-toggle="tab"><?php esc_html_e( 'Changelog','themotion-lite' ); ?></a></li>
		</ul>

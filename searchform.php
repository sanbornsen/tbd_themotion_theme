...
<form role="search" method="get" class="search-form search-toggle" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<label>
		...
		<input type="search" class="search-field" placeholder="<?php echo esc_attr_x( 'Search &hellip;', 'placeholder', 'themotion-lite' ); ?>" value="<?php echo esc_attr( get_search_query() ); ?>" name="s" title="<?php _ex( 'Search for:', 'label', 'themotion-lite' ); ?>">
	</label>

		...
		<span class="post-image-container">
			...
			if ( has_post_format( 'video' ) ) {
				if ( has_post_thumbnail() ) {
					...
					if ( $video_thumb_from_link === false ) {
						$video_thumb_from_link = get_template_directory_uri() . '/images/default-thumbnail.jpg';
					} ?>
					<img width="790" height="200" src="<?php echo esc_url( $video_thumb_from_link ); ?>" class="attachment-post-thumbnail wp-post-image" alt="">
					<?php
				}?>
